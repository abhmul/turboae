...
#from channelcoding import Trellis, conv_encode

from channelcoding import conv_encode
from utilities import dec2bitarray, bitarray2dec
#from channelcoding.map_c import backward_recursion, forward_recursion_decoding
